...
public class ForecastBlock extends Block {
    ...
    public InteractionResult use(BlockState p_60503_, Level p_60504_, BlockPos p_60505_, Player p_60506_,
        ...
        if (!p_60504_.isClientSide) {
            ...
            p_60506_.sendSystemMessage(Component.literal(String.format("%d days: %.2f", rateOften, (chance * 100F))
                    + "% from nearby biome temperature differences"));
            p_60506_.sendSystemMessage(
                    Component.literal(String.format("%d days: %.2f", rateLessOften, (chanceEvery10Days * 100F))
                            + "% from randomly trying once a day"));
        }
